...
import 'package:patient_app/src/common/convert_time.dart';
import 'package:patient_app/src/global_bloc.dart';
import 'package:patient_app/src/models/errors.dart';
import 'package:patient_app/src/models/medicine.dart';
import 'package:patient_app/src/models/medicine_type.dart';
import 'package:patient_app/src/ui/homepage/homepage.dart';
import 'package:patient_app/src/ui/new_entry/new_entry_bloc.dart';
import 'package:patient_app/src/ui/success_screen/success_screen.dart';
...
class _NewEntryState extends State<NewEntry> {
  ...
  Future onSelectNotification(String payload) async {
    ...
    await Navigator.push(
      context,
      new MaterialPageRoute(builder: (context) => MedHomePage()),
    );
  }
      ...
      child: Container(
        child: Row(
          ...
          children: <Widget>[
            ...
            DropdownButton<int>(
              iconEnabledColor: Color(0xFF00ACC1),
              hint: _selected == 0
                  ? Text(
                      "Select an Interval",
                      style: TextStyle(
        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
              ...
              color: isSelected ? Color(0xFF00ACC1) : Colors.white,
            ),
            child: Center(
              child: Padding(
                ...
                child: Icon(
                  ...
                  size: 75,
                  color: isSelected ? Colors.white : Color(0xFF00ACC1),
                ),
              ),
            ),
          ),
          Padding(
            ...
            child: Container(
              ...
              height: 30,
              decoration: BoxDecoration(
                color: isSelected ? Color(0xFF00ACC1) : Colors.transparent,
    ...
    return Padding(
      ...
      child: Text.rich(
        TextSpan(children: <TextSpan>[
          ...
          TextSpan(
            text: isRequired ? " *" : "",
            style: TextStyle(fontSize: 14, color: Color(0xFF00ACC1)),
          ),
        ]),
      ),
    );
